...
class Trader:
    ...
    def trade_pb1(self, state: TradingState) -> Tuple[Dict[str, List[Order]], Dict[str, Any]]:
        ...
        CROISSANTS_LIMIT = Product.CROISSANTS["LIMIT"]
        JAMS_LIMIT = Product.JAMS["LIMIT"]
        DJEMBES_LIMIT = Product.DJEMBES["LIMIT"]
        ...
        # If PB1 is overvalued: sell PB1, buy components
            ...
            best_bid_price, best_bid_quantity = self.get_best_bid(pb1_depth)
